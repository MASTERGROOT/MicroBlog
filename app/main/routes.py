...
def index():
    ...
    posts = db.paginate(current_user.following_posts(), page=page, per_page=current_app.config['POST_PER_PAGE'], error_out=False)
...
def explore():
    ...
    posts = db.paginate(query, page=page, per_page=current_app.config['POST_PER_PAGE'], error_out=False)
