...
from app.auth.form import LoginForm, Registration, ResetPasswordRequestForm, ResetPasswordForm
...
def register():
    ...
    if regis_form.validate_on_submit():
        ...
        return redirect(url_for('auth.login'))
    return render_template('auth/register.html', title=_('Register'), form=regis_form)
